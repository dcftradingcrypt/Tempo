...
- Date: 2026-02-18
- Symptom:
  - origin/main �̊m�F�菇�igit ls-tree -r --name-only origin/main, git cat-file -s origin/main:secrets/wallet.enc�j�����{���Awallet.enc ��ǐՉ^�p�ΏۂƂ��čĊm�F����
- Evidence (���O/tx/stacktrace/URL):
...
- Root Cause:
  - wallet.enc �̒ǐՏ�Ԃ� push �O�_�������ɉ^�p��i�߂郊�X�N
- Fix:
  - wallet.enc ���ŏ������� staging ���Agit commit �֎������މ^�p�𖾎�
- Prevent Recurrence (�Ĕ��h�~):
  - origin/main ��� wallet.enc �̗L���ƃT�C�Y�� push �O�ɖ���m�F
- Files Changed:
  - secrets/wallet.enc
  - CLAUDE.md
